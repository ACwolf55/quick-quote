...
function App() {
  ...
  <div id='our-forms'>
   ...
   <div className='link-descrip'>
    ...
    {/* <p className='descrip'> This is the quickest way to get our help! </p>
    <p className='descrip'>NO EXTRA FEE'S"</p> */}
  </div>
    ...
    {/* <p className='descrip'>the info needed to give you a QUICK QUOTE </p>
    <p className='descrip'>for your plumbing need(s)." </p>   */}
    </div>
